...
const Arrivals = () => {
  ...
  return (
    <div className='bg-slate-100'>
                <div className='w-full h-[200px] md:h-[500px] bg-slate-100 mb-[150px] px-10 pt-5'>
                    <Slider/>
                </div>
    ...
    return(
        <>
            <Swiper 
                ...
                <SwiperSlide className=' h-[200px] mmd:h-[500px] w-full bg-slate-100 flex justify-between'>
                    <img className=' h-[200px] md:h-[500px]' src="https://4.bp.blogspot.com/-8PHmhS2YqG4/UN2briGB3nI/AAAAAAAAAEU/26wv0R1GgBQ/s1600/african-clothing.jpg" alt="" />
                    <img className=' h-[200px] md:h-[500px]' src="https://4.bp.blogspot.com/-8PHmhS2YqG4/UN2briGB3nI/AAAAAAAAAEU/26wv0R1GgBQ/s1600/african-clothing.jpg" alt="" />
                </SwiperSlide>
                <SwiperSlide className=' h-[200px] md:h-[500px] w-full bg-slate-100 flex justify-between'>
                    <img className=' h-[200px] md:h-[500px]' src="https://4.bp.blogspot.com/-8PHmhS2YqG4/UN2briGB3nI/AAAAAAAAAEU/26wv0R1GgBQ/s1600/african-clothing.jpg" alt="" />
                    <img className=' h-[200px] md:h-[500px]' src="https://4.bp.blogspot.com/-8PHmhS2YqG4/UN2briGB3nI/AAAAAAAAAEU/26wv0R1GgBQ/s1600/african-clothing.jpg" alt="" />
                </SwiperSlide>
                <SwiperSlide className=' h-[200px] md:h-[500px] w-full bg-slate-100 flex justify-between'>
